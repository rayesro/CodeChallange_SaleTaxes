...
2.Add 1 by 1 product on the console / or copy and paste the input data on the console window
3.If you want to stop providing input then write an "x" or "X" (without double quotes) to proceed
4.The receipt will be shown on the console and the application is over
